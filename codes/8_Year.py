...
print (dict(all_flights['Year'].value_counts()))
print (len(dict(all_flights['Year'].value_counts())))
print()
print (dict(all_flights_no_delays_short['Year'].value_counts()))
print (len(dict(all_flights_no_delays_short['Year'].value_counts())))
print()
