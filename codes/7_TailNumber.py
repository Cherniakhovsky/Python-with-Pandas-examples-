...
all_flights_no_delays_short = all_flights.loc[(all_flights["IsArrDelayed"]=="NO"), ["Year", "UniqueCarrier", "FlightNum","TailNum"]]
...
##print (dict(all_flights['TailNum'].value_counts()))
##print (len(dict(all_flights['TailNum'].value_counts())))
##print()
##print (dict(all_flights_no_delays_short['TailNum'].value_counts()))
##print (len(dict(all_flights_no_delays_short['TailNum'].value_counts())))
##print()
...
print ()
print (len(sortByValue(mydict)[:count]))
