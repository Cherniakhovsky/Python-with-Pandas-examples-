...
all_flights_no_delays_short = all_flights.loc[(all_flights["IsArrDelayed"]=="NO"), ["Year", "UniqueCarrier", "FlightNum","TailNum", "Origin", "Dest", "Distance"]]

distance = dict(all_flights['Distance'].value_counts())

distanceOnTime = dict(all_flights_no_delays_short['Distance'].value_counts())

##print (dict(all_flights_no_delays_short['Distance'].value_counts()))
##print (len(dict(all_flights_no_delays_short['Distance'].value_counts())))
